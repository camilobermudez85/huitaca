...
generate_dockerfiles() {
	...
	sed -i 's/FROM java:7-jre/FROM huitaca\/jre-dev:openjdk-7/g' "${version}/Dockerfile"
	sed -i 's/FROM java:8-jre/FROM huitaca\/jre-dev:openjdk-8/g' "${version}/Dockerfile"
