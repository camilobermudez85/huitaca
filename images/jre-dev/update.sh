...
huitaca_jre_dev_versions=('openjdk-7' 'openjdk-8')
...
build_images() {
    for version in "${huitaca_jre_dev_versions[@]}"; do
	docker build -t huitaca/jre-dev:${version} ${version}
    done
}
